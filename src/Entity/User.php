...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getPrediction(int $eventId): ?Prediction
    {
        $predictions = array_filter($this->predictions->toArray(), static fn(Prediction $prediction): bool => $prediction->getEvent()->getId() === $eventId);

        return count($predictions) === 1 ? array_pop($predictions) : null;
    }
